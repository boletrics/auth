...
/**
 * AnimatedBackground component that:
...
export function AnimatedBackground({
	...
	const deviceCheck = useMemo(() => {
		...
		// Check screen size - hide on mobile/small screens
	...
	const dimmingColor =
		resolvedTheme === "dark"
			? "rgba(38, 43, 48, 0.7)" // dark background with 70% opacity
			: "rgba(255, 255, 255, 0.85)"; // light background with 85% opacity
